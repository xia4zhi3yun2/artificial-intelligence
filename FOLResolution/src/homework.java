...
//						}
	...
	public static boolean unify(List<String> pred1,List<String> pred2,Map<String,String> unify_map,boolean special_case){
		for(int n=1;n<pred1.size();n++){
			...
			else if(arg1.charAt(0)<='Z'&& arg1.charAt(0)>='A') {
				if(unify_map.containsKey(arg2)&&!arg1.equals(unify_map.get(arg2))) return false;
				unify_map.put(arg2,arg1);
			}
			else if(arg2.charAt(0)<='Z'&& arg2.charAt(0)>='A') {
				if(unify_map.containsKey(arg1)&&!arg2.equals(unify_map.get(arg1))) return false;
				unify_map.put(arg1,arg2);
			}
