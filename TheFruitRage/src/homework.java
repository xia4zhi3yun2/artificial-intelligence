...
public class homework {
	...
	public static int[] IterativeDFS(char[][] board){
		...
		while((endTime-startTime)<=500){
			for(int j=0;j<3;j++) prev[j]=move[j];
			try {  
...
//	        	System.out.println("time out!!!!");
	        	...
	        	//serious bug!!!!	
	        	//if break program here, move[] will return with [0,0,0]!!
	            return prev;
	        }  
			endTime=System.currentTimeMillis();
			
			//test
//			System.out.println("cost_time "+(endTime-startTime)/1000.0);
//			System.out.println("step "+step);
//			System.out.println("time_limit "+time/step*2);
//			System.out.println("layer "+i);
//			System.out.println("end_depth "+end_depth);
//			System.out.println("point "+move[0]);
//			System.out.println("position ("+move[1]+","+move[2]+")");
//			System.out.println("prev_point "+prev[0]);
//			System.out.println("\n");
		...
		for(int i=0;i<size;i++){
			for(int j=0;j<size;j++){
				if(board[i][j]!='*'&&!check_list[i][j]) {
					...
					//keep time less than 2s
					long endTime=System.currentTimeMillis();
					if (endTime-startTime>2000||endTime-startTime>time*1000/step*2) {  
